...
def get_loaders(data_files, selected_modals, batch_size=1, num_workers=0):
    ...
    #brain_dir = './dataset/MICCAI_BraTS2020_TrainingData'
    brain_dir = './dataset/MICCAI_BraTS_2018_Data_Training/HGG'
